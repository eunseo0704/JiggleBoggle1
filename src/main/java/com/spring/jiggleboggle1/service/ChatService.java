...
import com.spring.jiggleboggle1.mapper.ChatMapper;
import com.spring.jiggleboggle1.util.OpenAiStreamClient;
...
public class ChatService {
     ...
     */
    public List<JsonNode> buildMessagesForOpenAi(Long userId) {
